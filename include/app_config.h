...
/** @name Shared IIC0 bus configuration
 *  @{
 */
...
/** @name RTC 14 Click configuration
 *  @{
 */
...
/** @name Temp&Hum 27 Click configuration
 *  @{
 */
...
/** @name AGT0 1 ms application tick configuration
 *  @{
 */
...
/** @name P111 / IRQ4 B4 input configuration
 *  B4 starts, pauses and continues the stopwatch.
 *  @{
 */
...
/** @name BLE TINY Click / SCI3 configuration
 *  @{
 */
...
/** @name IPS Display 2 Click configuration
 *  @{
 */
...
#define IPS2_DASHBOARD_REFRESH_MS            (250UL)
#define IPS2_ENVIRONMENT_REFRESH_MS         (60UL)
#define IPS2_ASTRONOMY_REFRESH_MS           (250UL)
/** @} */

/** @name RA4M2 configurable interrupt vector layout
 *  @{
 */
